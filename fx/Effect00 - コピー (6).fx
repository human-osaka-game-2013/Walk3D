...
//if( num > 4 ) num = 4;
     ...
     LastBlendWeight += Weight[1];   // 最後の重みをここで計算しておく
      matCombWorld += matWorld[1] * Weight[1];
//LastBlendWeight += Weight[2];   // 最後の重みをここで計算しておく
      //matCombWorld += matWorld[2] * Weight[2];
   // 最後の重みを足し算
    LastBlendWeight += Weight[3];   // 最後の重みをここで計算しておく
      matCombWorld += matWorld[3] * Weight[3];
